...
import Deslizador from './componentes/menuVideo/Deslizador/Deslizador';
...
import ReproducirVideo from './componentes/menuVideo/Deslizador/ReproducirVideo';
 ...
 const router = createBrowserRouter(
  createRoutesFromElements(
    ...
    <Route path="/formulariovideos" element={<FormularioVideos/>} />
     ...
     <Route path="/ReproducirVideo" element={<ReproducirVideo/>}/>
